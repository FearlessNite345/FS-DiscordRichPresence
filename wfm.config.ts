...
export default defineConfig({
	...
	copy: [
		...
		{
			from: "src/util/config.json", // Directory for configuration or supplemental data files
			to: "config.json", // Target location in the root of the output directory
		},
		/*
        {
            * Single File Example
	...
	resource: {
		...
		//! DO NOT USE A LEADING SLASH — IT WILL BREAK THE BUILD!
		directory: "FS-DiscordRichPresence",
	},
});
